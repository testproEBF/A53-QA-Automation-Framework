...
Feature: Smart Playlist Creation
  ...
  Background:
    ...
    And I am logged in using "enrile.fuentes+100@testpro.io" and "#p3!X6D$%AR$VT"

  Scenario: Create smart playlist with one rule (Title)
    When I am on New Smart Playlist Form
...
#
  ...
  @order(100)
  Scenario: Delete all playlists
    When there are no existing playlists
